...
-   Always looking for more [examples of good PRs / PR descriptions](https://code-review.tidyverse.org/author/submitting.html#sec-good-pr-descriptions)

-   Give the guide a quick skim so you can recognize when you might be able to link to it
